...
**Plate fits overview (bottom section)**
Model fits for every well, laid out in plate order. Outline colour shows fit quality: green passes the RMSE threshold, red fails, grey has no fit. Use this to quickly spot problematic wells or patterns across the plate (e.g. edge effects, failed wells).
